        ...
        <div className='w-full overflow-hidden rounded-md shadow-lg cursor-pointer bg-wsGrey-200'>
          <Tabs>
            <div className='flex flex-col md:flex-row'>
              <div className='md:w-4/12 bg-wsGrey-900'>
                <div className='flex gap-4 px-2 text-center text-white md:pt-8 md:flex-col sm:gap-8 sm:p-10'>
                  <Tab>
              ...
              <div className='w-full p-5 md:text-left md:p-10 md:w-8/12'>
                <Panel>
                ...
                <Panel>
                  <p className='text-green-900'>
                    ...
                    first thing the doctor does to the patient is diagonise
                    before proposing a remedy. The same goes to the mechanic ,
                    if a clients car breaks down or starts being faulty. For
                    WabiSabi, we do our homework to diagnose our clients
                    challenges so that we better understand the needs and
                    requirments before proposing solutions. The biggest
                    challenge we face is that clients come with fixed ideas of
                    what their competitors are doing and dont understand that
                    what might have work for another business might be the wrong
                    solution for theirs.
                  </p>
                </Panel>
                <Panel>
                ...
                <Panel>
                  <p className='text-green-900'>
                    ...
                    solutions. We pick the most important bits of the ideas
                    which can be feature to create solution. By doing so it
                    helps reduce cost and we efficiently solve the challenge and
                    build a solution that is sustainable.
                  </p>
                </Panel>
                <Panel>
                  <p className='text-green-900'>
                    We test it out to the users and clients to validate on the
                    ideas and the solutions propose. Normally, we do this in
                    small groups of beta users and if the product does not solve
                    the problem we revisit the problem and try to solve based on
                    the feedback they provide.
                  </p>
                </Panel>
                <Panel>
                  <p className='text-green-900'>
                    Validating ideas is a really good practice to have inorder
                    to avoid building the wrong thing or product. We enter the
                    building phase where we develop the product fully in sprints
                    which are usually between 4-6 week apart.That way we can
                    control the cost as well as keep the team engaged and
